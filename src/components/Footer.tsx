    ...
    <footer className="bg-[#f9f9f9] pt-16 pb-8 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-24 mb-16">
          {/* Social */}
          <div>
            <h3 className="text-sm font-semibold tracking-widest uppercase mb-6 text-gray-900">Follow @mojluxury</h3>
          ...
          {/* Newsletter */}
          <div>
            <h3 className="text-sm font-semibold tracking-widest uppercase mb-6 text-gray-900">Stay Updated!</h3>
            <p className="text-sm text-gray-500 mb-6">
              Subscribe to get promotions, new products and sales updates directly to your inbox.
            </p>
            <form className="flex flex-col space-y-3" onSubmit={(e) => e.preventDefault()}>
              <input 
                type="email" 
                placeholder="Your email" 
                className="bg-transparent border border-gray-300 px-4 py-3 text-sm focus:outline-none focus:border-gray-900 transition-colors"
                required
              />
              <button 
                type="submit" 
                className="bg-black text-white px-4 py-3 text-sm tracking-widest uppercase hover:bg-gray-800 transition-colors"
              >
                Subscribe
              </button>
            </form>
